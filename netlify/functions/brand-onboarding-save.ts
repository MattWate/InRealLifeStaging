...
const SECTION_BY_FIELD: Record<string, string> = {
  ...
  activeMarkets: 'brand', brandPrimaryCategory: 'brand', brandSecondaryCategories: 'brand', brandDescription: 'brand', brandDifferentiator: 'brand', brandValues: 'brand', salesChannels: 'brand', competitorLockouts: 'brand', brandNeighbourhood: 'brand',
  productScope: 'product', productName: 'product', productWebpage: 'product', productCategory: 'product', productSubcategory: 'product',
  hasProductWebpage: 'product', priceCurrency: 'product', priceMin: 'product', priceMax: 'product', variants: 'product', sameProductAvailability: 'product', productMarkets: 'product', productChannels: 'product', internationalShipping: 'product', internationalShippingRegions: 'product', legalSafetyCompliance: 'product', additionalProducts: 'product',
  ...
  spendingPower: 'audience', travelPurpose: 'audience', discoveryChannels: 'audience', audienceExclusions: 'audience', audienceEvidence: 'audience', audienceNotes: 'audience', secondaryAudienceEnabled: 'audience', secondaryAudienceDescription: 'audience', secondaryAudienceEvidence: 'audience', secondaryAudienceGeography: 'audience', secondaryAgeGroups: 'audience', secondaryLifeStages: 'audience', secondarySpendingPower: 'audience', secondaryTravelPurpose: 'audience', secondaryDiscoveryChannels: 'audience', secondaryDecisionFactors: 'audience', secondaryDiscoveryOpenness: 'audience', secondaryAudienceExclusions: 'audience', secondaryAudienceNotes: 'audience',
  customerOutcome: 'need', customerOutcomeDetail: 'need', needContext: 'need', currentAlternative: 'need', alternativeExplanation: 'need', primaryBarrier: 'need', barrierReducers: 'need', decisionNotes: 'need',
  marketingChannels: 'value-success', marketingChannelRank: 'value-success', measuredAcquisitionChannel: 'value-success', paidMarketing: 'value-success', experientialHistory: 'value-success', experientialEffectiveness: 'value-success', experientialEvidence: 'value-success', irlOpportunity: 'value-success', primarySuccessResult: 'value-success', successSignals: 'value-success',
  brandSuggestedPlacements: 'operations', handlingRequirements: 'operations', supplyCapability: 'operations', initialSupplyLimit: 'operations',
